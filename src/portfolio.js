  ...
  certifications: [
    {
      ...
      alt_name: "NodeJS and React",
      color_code: "#E2405F",
    },
    {
      title: "UI/UX Responsive Design with HTML, CSS, Bootstrap5",
      subtitle: "UI/UX with Udemy",
      logo_path:
    ...
    {
      title: "Implement High Fidelity Design with Material-UI and ReactJS",
      subtitle: "Material-UI with ReactJS - Udemy",
      logo_path:
    ...
    {
      title: "Proxmox VE6",
      subtitle: "Networking with Proxmox VE6",
      logo_path:
  ...
  data: [
    {
      id: "0",
      name: "NFTMarketPlace",
      url: "https://github.com/SumitGA/NFTMarketPlace",
      description:
    ...
    },
    {
      id: "1",
      name: "VideoChat",
      url: "https://github.com/SumitGA/VideoChat",
      description:
    ...
    },
    {
      ...
      languages: [
        ...
        {
          name: "ERB",
          iconifyClass: "vscode-icons:file-type-erb",
        },
      ],
    },
    {
      id: "3",
      name: "ChatAPI",
      url: "https://github.com/SumitGA/chatApi",
      description:
    ...
    },
    {
      ...
      description: "This is a simple IDE created with react and typescript",
      languages: [
        {
          name: "NodeJS",
          iconifyClass: "vscode-icons:file-type-node",
