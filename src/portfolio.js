...
const greeting = {
	...
	subTitle: 'Full Stack Developer, Open Source and AI Enthusiast 🔥. Always learning.',
	resumeLink: 'https://drive.google.com/file/d/1Fh8v_EZYpEUidmfw7W7xHiYnuI0UFEeF/view?usp=sharing',
...
const degrees = {
	degrees: [
		...
		},
		{
			...
			alt_name: 'Plus2',
			duration: '2011 - 2013',
			descriptions: [ '⚡ I have studied core subjects like Physics, Chemistry, Maths, Computer Science, etc.' ],
...
const projects = {
	data: [
		...
		},
		{
			...
			description: 'A Discord Bot to send Automatic messages to serer channel in regular time difference.',
			languages: [
				{
					name: 'Python',
					iconifyClass: 'logos-python'
